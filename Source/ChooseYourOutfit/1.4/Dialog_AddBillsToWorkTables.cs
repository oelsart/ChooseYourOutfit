...
public class Dialog_AddBillsToWorkTables : Window
{
    public Dialog_AddBillsToWorkTables(IEnumerable<ThingDef> apparels, Dictionary<ThingDef, ThingDef> stuff)
    {
        ...
        Apparels = apparels.OrderByDescending(a => a.label).ToList();
    ...
    private static IEnumerable<Building_WorkTable> AllWorkTables => Find.CurrentMap.listerBuildings.AllBuildingsColonistOfClass<Building_WorkTable>();
